...
<button class="btAdd button">Add new project</button>
<div class='add-section'>
<div class='add-project'>
<span class='button close-project'>Close</span>
<h2>Project form</h2>
<form action='project_actions/actions/add.php' method='POST'>

<div class='project-options'>
    <h3>Project options</h3>
    <p>Project name</p>
    <fieldset>
        <input type='text' name='project-name' id='project-name' tabindex='0'>
    </fieldset>
